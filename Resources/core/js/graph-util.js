...
function hueShiftedColorSet(num, categories){
    ...
    if(window.city == 'palo_alto'){
    	...
    	var colorMap = {'Expenses':'#F3715B', 
    					...
    					'Total Savings Carried Forward':'#F3715B', 
    					'Maintenance of Right of Way':'#00B039',
