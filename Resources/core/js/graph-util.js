...
function hueShiftedColorSet(num, categories){
	...
	var colors = ['#5578B4', '#AB72A6', '#F3715B', '#00B039', '#F79750', '#A9CEEC', '#CACEC3', '#AAA7CA', '#66C190', '#DF8B96', '#68B3E2', '#FFDB4E', '#96D4C3', '#A7A9AC', '#BBBA59', '#E7A7CB', '#996633'];
