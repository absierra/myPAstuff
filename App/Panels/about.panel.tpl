...
<div id="content_wrapper">
    ...
    <div id="content" class="fullwidth">
        ...
        <p>A city's revenue comes in the form of taxes and fees. That revenue is organized into funds, upon which specific departments, divisions, and city programs can draw for their expendictures. Funds and departments have their own hierarchical structures. For example, the Refuse Fund, the Electric Fund, the Gas Fund, and others are all grouped together under Enterprise Funds. Departments are broken down into divisions (sometimes called programs). For example, The City Attorney Department has an Administrative division, a Consultation and Advisory division, and others.</p>
        ...
        <p>Moreover, a city's various departments often times have similar types of expenditures. For example, almost all departments spend money on salaries and benefits for their employees. This allows a budget to offer an additional perspective on a city's finances: how much money is being spent on various categories of expenditures, instead of a breakdown merely by department, division, or program.</p>

        <h1>How to use Delphi Budgets</h1>
        <p>Delphi Budgets offers the ability to explore a budget in a simple graphical user interface, making it easier than pouring through hundreds of pages of a budget document [is this too pejorative / insulting to cities?] to get at the information you want about your city's finances.</p>
        <p>The interface is organized into two main panels. The panel on the left contains two colums--one for Fund and the other for Department--that allows you to select the data you want to see in the right panel, which contains the resulting graph.</p>
        ...
        <p>Hover your mouse over graph data points to get more information, and where applicable, you can click to drill down deeper.</p>
        <p>[Clearing all selections?]</p>
        <p>[Multi-select?]</p>
    </div>
</div>